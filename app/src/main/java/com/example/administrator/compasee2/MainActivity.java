package com.example.administrator.compasee2;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public void onResume() {
        ...
        compass_sensor = sensorManager.getDefaultSensor(Sensor.TYPE_ORIENTATION);
        // 给传感器注册监听：
        ...
        sensorManager.registerListener(this, compass_sensor, SensorManager.SENSOR_DELAY_GAME);
        super.onResume();
    }
